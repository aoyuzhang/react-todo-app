  ...
  const aboutData = [
    {
      ...
      description:
        ...
        "delete, submit and edit items."+
        " To edit items, simply double click"+
        " on it. Once you are done, "+
        "press the enter key to resubmit."+
        " This app will persist your data in "+
        "the browser local storage. "+
        "So whether you reload, close"+
        " your app or reopened it, you still"+
